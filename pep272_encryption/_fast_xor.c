...
{
    "distutils": {
        "name": "pep272_encryption._fast_xor",
        "sources": [
            "pep272_encryption/_fast_xor.pyx"
        ]
    },
    "module_name": "pep272_encryption._fast_xor"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pep272_encryption___fast_xor
#define __PYX_HAVE_API__pep272_encryption___fast_xor
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'pep272_encryption._fast_xor' */
#define __Pyx_MODULE_NAME "pep272_encryption._fast_xor"
int __pyx_module_is_main_pep272_encryption___fast_xor = 0;

/* Implementation of 'pep272_encryption._fast_xor' */
...
static PyObject *__pyx_n_s_fast_xor;
static PyObject *__pyx_n_s_i;
static PyObject *__pyx_n_s_la;
static PyObject *__pyx_n_s_lb;
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_pep272_encryption__fast_xor;
...
static PyObject *__pyx_pw_17pep272_encryption_9_fast_xor_1_fast_xor(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_fast_xor (wrapper)", 0);
  {
    ...
    __pyx_v_a = __Pyx_PyObject_AsWritableUString(values[0]); if (unlikely((!__pyx_v_a) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_la = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_la == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyObject_AsWritableUString(values[2]); if (unlikely((!__pyx_v_b) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
    __pyx_v_lb = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_lb == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
  }
 ...
 */
  ...
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_t_3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 12, __pyx_L1_error)
  ...
  __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)(&PyByteArray_Type)), __pyx_t_5, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_c = ((PyObject*)__pyx_t_4);
  __pyx_t_4 = 0;

  /* "pep272_encryption/_fast_xor.pyx":14
 *     cdef bytearray c = bytearray(min(la, lb))
 * 
 *     for i in range(min(la, lb)):             # <<<<<<<<<<<<<<
 *         c[i] = a[i] ^ b[i]
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2+=1) {
    ...
    /* "pep272_encryption/_fast_xor.pyx":15
 * 
 *     for i in range(min(la, lb)):
 *         c[i] = a[i] ^ b[i]             # <<<<<<<<<<<<<<
 * 
 *     return c
 */
    if (unlikely(((__pyx_v_a[__pyx_v_i]) ^ (__pyx_v_b[__pyx_v_i])) < 0 || ((__pyx_v_a[__pyx_v_i]) ^ (__pyx_v_b[__pyx_v_i])) > 255)) {
      PyErr_SetString(PyExc_ValueError, "byte must be in range(0, 256)"); __PYX_ERR(0, 15, __pyx_L1_error)
    }
    if (unlikely(__Pyx_SetItemInt_ByteArray(__pyx_v_c, __pyx_v_i, ((unsigned char)((__pyx_v_a[__pyx_v_i]) ^ (__pyx_v_b[__pyx_v_i]))), int, 1, __Pyx_PyInt_From_int, 0, 1, 1) < 0)) __PYX_ERR(0, 15, __pyx_L1_error)
  }

  /* "pep272_encryption/_fast_xor.pyx":17
 *         c[i] = a[i] ^ b[i]
 * 
 *     return c             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_fast_xor, __pyx_k_fast_xor, sizeof(__pyx_k_fast_xor), 0, 0, 1, 1},
  {&__pyx_n_s_i, __pyx_k_i, sizeof(__pyx_k_i), 0, 0, 1, 1},
  {&__pyx_n_s_la, __pyx_k_la, sizeof(__pyx_k_la), 0, 0, 1, 1},
  {&__pyx_n_s_lb, __pyx_k_lb, sizeof(__pyx_k_lb), 0, 0, 1, 1},
  {&__pyx_n_s_main, __pyx_k_main, sizeof(__pyx_k_main), 0, 0, 1, 1},
  {&__pyx_n_s_pep272_encryption__fast_xor, __pyx_k_pep272_encryption__fast_xor, sizeof(__pyx_k_pep272_encryption__fast_xor), 0, 0, 1, 1},
  {&__pyx_kp_s_pep272_encryption__fast_xor_pyx, __pyx_k_pep272_encryption__fast_xor_pyx, sizeof(__pyx_k_pep272_encryption__fast_xor_pyx), 0, 0, 1, 0},
 ...
 *     Fast bitwise xor between to buffers.
 */
  __pyx_tuple_ = PyTuple_Pack(6, __pyx_n_s_a, __pyx_n_s_la, __pyx_n_s_b, __pyx_n_s_lb, __pyx_n_s_i, __pyx_n_s_c); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(4, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_pep272_encryption__fast_xor_pyx, __pyx_n_s_fast_xor, 4, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_fast_xor(void); /*proto*/
PyMODINIT_FUNC init_fast_xor(void)
#else
PyMODINIT_FUNC PyInit__fast_xor(void); /*proto*/
PyMODINIT_FUNC PyInit__fast_xor(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__fast_xor(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_fast_xor", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pep272_encryption___fast_xor) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pep272_encryption._fast_xor")) {
      if (unlikely(PyDict_SetItemString(modules, "pep272_encryption._fast_xor", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  /* "pep272_encryption/_fast_xor.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 * 
 * @cython.embedsignature(True)
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pep272_encryption._fast_xor", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pep272_encryption._fast_xor");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
